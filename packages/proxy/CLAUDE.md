...
**Public API (barrel `src/index.ts`):** startProxy, isProxyRunning, createHandler, createRouter, createProviderFactory, loadSdk, createRealGateway, the adapters, validateProviderConfig, createNameGenerator, NameGenerator, NameGenError, buildNamePrompt, NAME_PROMPT_MAX, and all public types.
