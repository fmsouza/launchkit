...
/**
 * The Updates settings page: the in-app updater controls (current version,
 * channel toggle, manual check) plus the LLM response timeout fields.
 * Moved here from GeneralPage so General can host only the session-name picker.
 * Data enters via the `useUpdate` and `useTimeoutSettings` hooks — the layout
 * stays presentational. Identical markup to the former General sections.
 */
export const UpdatesPage = (): ReactElement => {
